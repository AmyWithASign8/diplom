...
import {Button, Group, Header, Menu, Stack, Text, useMantineTheme} from "@mantine/core";
    ...
    return (
        <Header height={"100%"} p={"1%"}>
            <Group position={"apart"}>
                ...
                <Button component={Link} to={'/admin-panel'}>Главная</Button>
                <Menu>
                    <Menu.Target>
                ...
                <Menu>
                    ...
                    <Menu.Dropdown>
                        <Stack>
                            <Button color={'green'} component={Link} to={'add-product'}>Добавить продукт</Button>
                            <Button color={'orange.5'} component={Link} to={'add-product'}>Добавить тип продукта</Button>
                ...
                <Menu>
                    ...
                    <Menu.Dropdown>
                        <Stack>
                            ...
                            <Button color={'red'}>Удалить отзыв</Button>
                        </Stack>
                    </Menu.Dropdown>
                </Menu>
                <Menu>
